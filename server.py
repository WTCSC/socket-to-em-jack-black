    ...
    if choice == "start": #if the client does enter start
        ...
        while player_total < 21:
            ...
            if choice1 in ("hit", "h"):
                ...
                if player_total > 21:
                    currency = currency/2
                    client1.send("You busted! Game over, You have {currency} Dollars.".encode())
        ...
        if player_total <= 21:
            ...
            while dealer_total < 17:
                ...
                if dealer_total > 21:
                    currency = currency*2
                    client1.send("\nDealer busted! You win! You have {currency} Dollars.".encode())
                    break
            ...
            if player_total <= 21 and dealer_total <= 21:
                if player_total > dealer_total:
                    currency = currency*2
                    client1.send(f"You win! Your total: {player_total}, Dealer's total: {dealer_total}, You have {currency} Dollars.".encode())
                elif player_total < dealer_total:
                    currency = currency/2
                    client1.send(f"You lose! Your total: {player_total}, Dealer's total: {dealer_total}, You have {currency} Dollars..".encode())
                else:
                    currency = currency
                    client1.send(f"It's a tie! Your total: {player_total}, Dealer's total: {dealer_total}, You have {currency} Dollars..".encode())
...
# Ask the player if they want to play again
    ...
    if "no" in play_again:
        ...
        continue  # Restart the game loop properly
